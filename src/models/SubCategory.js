...
const subCategorySchema = new mongoose_1.default.Schema({
    ...
    brandId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Brand', required: true }, // Reference to Brand
    categoryId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Category', required: true }, // Reference to Category
